...
const About = () => {
    return (
        <div className="mt-10 bg-black text-white p-2">
          ...
          <h3 className="text-3xl w-full text-center mb-1">Currently Reading</h3>
          <p className="text-md w-full text-center mb-4">The Bourne Trilogy</p>

          <h3 className="text-3xl w-full text-center mb-1">Dream Destination</h3>
          <p className="text-md w-full text-center mb-4">Lake Como</p>
        </div>
    )
}
